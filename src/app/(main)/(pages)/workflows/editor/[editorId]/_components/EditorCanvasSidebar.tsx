...
import { CONNECTIONS, EditorCanvasDefaultCardTypes } from '@/lib/const'
import EditorCanvasIconHelper from './editor-canvas-icon-helper'
import { fetchBotSlackChannel, onConnections, onDragStart } from '@/lib/editor-utils'
...
const EditorCanvasSidebar = ({nodes}: props) => {
  ...
  const { googleFile, setSlackChannels } = useChannelStore()
